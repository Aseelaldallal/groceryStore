...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__inventory__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__inventory___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__inventory__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__helper_js__ = __webpack_require__(28);
...
/* harmony export (immutable) */ __webpack_exports__["c"] = getFruitCount;


const updateFruitStock = amount => {
  return {
    type: UPDATE_FRUIT_STOCK,
    amount: amount
  };
};
/* harmony export (immutable) */ __webpack_exports__["d"] = updateFruitStock;


const explainFruitStock = () => {
  return {
    type: EXPLAIN_FRUIT_STOCK
  };
};
/* harmony export (immutable) */ __webpack_exports__["a"] = explainFruitStock;


const initialState = {
  inventory: __WEBPACK_IMPORTED_MODULE_0__inventory___default.a,
  originalList: {},
  currentList: {},
  explained: '',
  counted: false
...
const fruitReducer = (state = initialState, action) => {
  switch (action.type) {
    case GET_FRUIT_COUNT:
      const originalList = Object(__WEBPACK_IMPORTED_MODULE_1__helper_js__["a" /* countFruit */])(state.inventory);
      const currentList = Object.keys(state.currentList).length ? state.currentList : originalList;
    ...
    case UPDATE_FRUIT_STOCK:
      originalList = state.count ? state.originalList : Object(__WEBPACK_IMPORTED_MODULE_1__helper_js__["a" /* countFruit */])(state.inventory);
      currentList = Object.keys(state.currentList).length ? state.currentList : originalList;
      return _extends({}, state, {
        originalList: originalList,
        currentList: Object(__WEBPACK_IMPORTED_MODULE_1__helper_js__["c" /* stockUp */])(state.currentList, action.amount),
        counted: true
      });
    case EXPLAIN_FRUIT_STOCK:
      originalList = state.count ? state.originalList : Object(__WEBPACK_IMPORTED_MODULE_1__helper_js__["a" /* countFruit */])(state.inventory);
      currentList = Object.keys(state.currentList).length ? state.currentList : originalList;
      const explained = Object(__WEBPACK_IMPORTED_MODULE_1__helper_js__["b" /* explain */])(state.currentList);
      return _extends({}, state, {
        originalList: originalList,
        currentList: currentList,
        counted: true,
...
/* harmony export (immutable) */ __webpack_exports__["b"] = fruitReducer;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__redux_store__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__redux_modules_fruit_js__ = __webpack_require__(8);



__WEBPACK_IMPORTED_MODULE_0__redux_store__["a" /* default */].dispatch(Object(__WEBPACK_IMPORTED_MODULE_1__redux_modules_fruit_js__["c" /* getFruitCount */])());
__WEBPACK_IMPORTED_MODULE_0__redux_store__["a" /* default */].dispatch(Object(__WEBPACK_IMPORTED_MODULE_1__redux_modules_fruit_js__["d" /* updateFruitStock */])(10));
__WEBPACK_IMPORTED_MODULE_0__redux_store__["a" /* default */].dispatch(Object(__WEBPACK_IMPORTED_MODULE_1__redux_modules_fruit_js__["a" /* explainFruitStock */])());
...
/* harmony default export */ __webpack_exports__["a"] = (Object(__WEBPACK_IMPORTED_MODULE_0_redux__["b" /* createStore */])(__WEBPACK_IMPORTED_MODULE_1__reducers__["a" /* default */]));
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_redux__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__modules_fruit__ = __webpack_require__(8);


/* harmony default export */ __webpack_exports__["a"] = (Object(__WEBPACK_IMPORTED_MODULE_0_redux__["a" /* combineReducers */])({
  produce: __WEBPACK_IMPORTED_MODULE_1__modules_fruit__["b" /* fruitReducer */]
}));
...
const data = [['apples', 73], ['pears', 12], ['oranges', 97], ['grapes', 387], ['grapes', 88], ['pears', 33], ['apples', 75], ['grapes', 23], ['oranges', 86], ['kiwis', 201]];
...
/* harmony export (immutable) */ __webpack_exports__["a"] = countFruit;


const stockUp = (fruitList, quantity) => {
  for (let key in fruitList) {
    fruitList[key] += quantity;
  }
};
/* harmony export (immutable) */ __webpack_exports__["c"] = stockUp;


const explain = fruitList => {
...
/* harmony export (immutable) */ __webpack_exports__["b"] = explain;
